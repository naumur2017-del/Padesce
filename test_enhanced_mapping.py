#!/usr/bin/env python3
"""
Test la fonction de mapping améliorée pour vérifier les résultats
"""
...
def test_enhanced_stats_function():
    """Test la fonction _build_formateur_stats_enhanced"""
    ...
    try:
        ...
        print("Exécution de _build_formateur_stats_enhanced...")
...
if __name__ == "__main__":
    ...
    print("TEST DE LA FONCTION DE MAPPING AMÉLIORÉE\n")
    
    if test_enhanced_stats_function():
        print("\n" + "="*60)
        print("TEST TERMINÉ")
        print("Vérifiez si le nombre de codes PRESTA a augmenté.")
    else:
        print("\nÉCHEC DU TEST")
        sys.exit(1)
