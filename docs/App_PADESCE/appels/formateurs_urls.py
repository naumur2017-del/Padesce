...
urlpatterns = [
    ...
    path(
        ...
        formateur_transcription_detail,
        name="formateur_transcription_detail",
    ),
    path(
        "<int:pk>/transcription/download/",
        formateur_transcription_download,
        name="formateur_transcription_download",
    ),
    ...
    path(
        ...
        start_filtered_formateurs_transcription,
        name="start_filtered_formateurs_transcription",
    ),
    path(
        "tools/transcribe-filtered-status/",
        filtered_formateurs_transcription_status,
        name="filtered_formateurs_transcription_status",
    ),
    path(
        "tools/transcribe-filtered-stop/",
        stop_filtered_formateurs_transcription,
        name="stop_filtered_formateurs_transcription",
    ),
]
