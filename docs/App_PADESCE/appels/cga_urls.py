...
urlpatterns = [
    ...
    path("<int:pk>/transcription/download/", cga_transcription_download, name="cga_transcription_download"),
    ...
    path("tools/transcribe-filtered/", start_filtered_cga_transcription, name="start_filtered_cga_transcription"),
    path("tools/transcribe-filtered-status/", filtered_cga_transcription_status, name="filtered_cga_transcription_status"),
    path("tools/transcribe-filtered-stop/", stop_filtered_cga_transcription, name="stop_filtered_cga_transcription"),
]
