...
def _build_satisfaction_dashboard_data(request):
    ...
    # NEW: Full list of prestations for Top 5 ranking, ignoring qualified filter
...
def satisfaction_map_data(request):
    """
    Returns the top 5 BEST performing prestations for each region.
    Used by the interactive Leaflet map.
    """
    dashboard = _build_satisfaction_dashboard_data(request)
