...
class ConcordanceCampaignPageTests(TestCase):
    ...
    def test_duplicate_presta_ids_are_merged_with_canonical_database_labels(self):
        ...
        self.assertEqual(row["total_hommes"], 1)
        self.assertEqual(row["total_femmes"], 1)
        self.assertEqual(row["total_hommes_fenetre_2"], 1)
        self.assertEqual(row["total_femmes_fenetre_3"], 1)
