...
urlpatterns = [
    ...
    path('documentation/', lazy_view('App_PADESCE.reporting.views.reporting_manual_view'), name='reporting_manual'),
    path('documentation/download/', lazy_view('App_PADESCE.reporting.views.reporting_manual_download_view'), name='reporting_manual_download'),
