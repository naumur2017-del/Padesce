...
class ImportApprenantsForm(forms.Form):
    fichier = forms.FileField(
        ...
        help_text=(
            ...
            "Intitule dispense, Fenetre, Ville formation, Arrondissement, Departement, "
            "Region, Lieu, Precision lieu, Longitude, Latitude, 1er numero, 2e numero, "
            "Cohorte, Tel formateur, Code (optionnel)"
        ),
    )
