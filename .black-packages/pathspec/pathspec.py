...
from pathspec.util import CheckResult, StrPath, TreeEntry, TStrPath, _is_iterable, normalize_file
...
class PathSpec(object):
    ...
    @deprecated(("PathSpec.match_tree() is deprecated. Use .match_tree_files() instead."))
